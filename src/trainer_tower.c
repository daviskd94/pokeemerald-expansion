...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_SUPER_NERD_FRLG,     FACILITY_CLASS_HEX_MANIAC,          MALE},
    ...
    {OBJ_EVENT_GFX_SUPER_NERD_FRLG,     FACILITY_CLASS_BUG_MANIAC,          MALE},
    ...
    {OBJ_EVENT_GFX_BATTLE_GIRL_FRLG,    FACILITY_CLASS_BATTLE_GIRL,       FEMALE},
    ...
    {OBJ_EVENT_GFX_SUPER_NERD_FRLG,     FACILITY_CLASS_POKEMANIAC,          MALE},
    {OBJ_EVENT_GFX_SUPER_NERD_FRLG,     FACILITY_CLASS_SUPER_NERD_FRLG,          MALE},
    {OBJ_EVENT_GFX_HIKER_FRLG,     FACILITY_CLASS_HIKER_FRLG,               MALE},
    {OBJ_EVENT_GFX_BIKER_FRLG,          FACILITY_CLASS_BIKER_FRLG,               MALE},
    {OBJ_EVENT_GFX_SUPER_NERD_FRLG,     FACILITY_CLASS_BURGLAR_FRLG,             MALE},
    ...
    {OBJ_EVENT_GFX_BIKER_FRLG,          FACILITY_CLASS_CUE_BALL_FRLG,            MALE},
    ...
    {OBJ_EVENT_GFX_BATTLE_GIRL_FRLG,    FACILITY_CLASS_CRUSH_GIRL_FRLG,        FEMALE},
...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_BATTLE_GIRL_FRLG,    OBJ_EVENT_GFX_BLACKBELT,      FACILITY_CLASS_CRUSH_KIN_FRLG,       FEMALE,   MALE},
