...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_AQUA] = { _("Team Genesis") },
    ...
    [TRAINER_CLASS_ROTCART] = { _("Rival"), 15 },
    [TRAINER_CLASS_PRESIDENT] = { _("President"), 15, BALL_DUSK },
    ...
    [TRAINER_CLASS_DOJO_MASTER] = { _("Dojo Master") },
    [TRAINER_CLASS_GENESIS_BOSS] = { _("Genesis Boss") },
    [TRAINER_CLASS_DRAGON_MASTER] = { _("Dragon Lord") },
