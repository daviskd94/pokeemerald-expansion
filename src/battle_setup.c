...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_MAIN_HALL_LYSSA, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MAP_MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_CELESTE, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MAP_MT_CHIMNEY),
...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    case SPECIES_GROUDON_PRIMAL:
        CreateBattleStartTask(B_TRANSITION_GROUDON, MUS_EMPTY2);
        break;
    case SPECIES_KYOGRE:
    case SPECIES_KYOGRE_PRIMAL:
        CreateBattleStartTask(B_TRANSITION_KYOGRE, MUS_EMPTY2);
        break;
...
void StartGroudonKyogreBattle(void)
{
    ...
    if (gGameVersion == VERSION_RUBY)
        CreateBattleStartTask(B_TRANSITION_ANGLED_WIPES, MUS_EMPTY2); // GROUDON
    else
        CreateBattleStartTask(B_TRANSITION_RIPPLE, MUS_EMPTY2); // KYOGRE
