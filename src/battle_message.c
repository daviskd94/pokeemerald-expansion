...
static const u8 sText_Someones[] = _("University");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_NOTVERYEFFECTIVE]                     = COMPOUND_STRING("{COLOR DARK_GRAY}It's not very effective…"),
    [STRINGID_SUPEREFFECTIVE]                       = COMPOUND_STRING("{COLOR LIGHT_GRAY}It's super effective!"),
    ...
    [STRINGID_WALLYUSEDITEM]                        = COMPOUND_STRING("Mr. Dr. Professor Cyrus used {B_LAST_ITEM}!"), //no decapitalize until it is everywhere
    ...
    [STRINGID_YOUTHROWABALLNOWRIGHT]                = COMPOUND_STRING("Oh my! This Pokémon is sick! I must save it!"),
...
const u8 gText_WhatWillWallyDo[] = _("What will Mr. Dr.\nProf. Cyrus do?");
...
const u8 gText_BattleTracieName[] = _("Tracie");
