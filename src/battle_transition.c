...
static const u16 sMugshotPal_Tracie[] = INCBIN_U16("graphics/battle_transitions/yellow_bg.gbapal");
static const u16 sMugshotPal_Mario[] = INCBIN_U16("graphics/battle_transitions/mario.gbapal");
...
static const u16 *const sOpponentMugshotsPals[MUGSHOT_COLOR_COUNT] =
{
    ...
    [MUGSHOT_COLOR_MARIO] = sMugshotPal_Mario
};
