...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_South_Campus_Dorm_Door,                       &gTileset_DormHallway, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_South_Campus_Dorm, sDoorAnimPalettes_SouthCampusDorm},
    {METATILE_DormHallway_SouthCampus_Door,                 &gTileset_DormHallway, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_DormHallway_Door, sDoorAnimPalettes_DormHallwayDoor},
    {METATILE_Dewford_SouthCampus_Cafeteria,                &gTileset_SouthCampusCafeteria, DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_Cafeteria_Door, sDoorAnimPalettes_SouthCampusCafeteria},
    {METATILE_TractorUniversity_Door_Main_Hall,             &gTileset_TractorUniversity, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_NorthCampus_MainHall, sDoorAnimPalettes_NorthCampus_MainHall},
    {METATILE_TractorUniversity_Door_Main_Hall_2,           &gTileset_TractorUniversity, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_NorthCampus_MainHall_2, sDoorAnimPalettes_NorthCampus_MainHall_2},
    {METATILE_MainHall_Main_Hall_Classroom_Door,            &gTileset_MainHall, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_MainHall_Classroom_Door, sDoorAnimPalettes_MainHall_Classroom_Door},
