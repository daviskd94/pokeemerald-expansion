...
const u32 gMoveTypes_Gfx[] = INCBIN_U32("graphics/types_swsh_summary_screen/move_types.4bpp.lz");
...
const u32 gNameBox_Gfx[] = INCBIN_U32("graphics/text_window/name_box.4bpp");
