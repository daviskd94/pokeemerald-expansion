...
const u8 gText_ThisIsAPokemon[] = _("I lead the research team in the\nstudy of Pokémon development.{PAUSE 96}\p");
...
const u8 gText_SwitchPokedexListings[] = _("Switch Pokémon listings.");
...
const u8 gText_DexHoennTitle[] = _("Tractoria Dex");
...
const u8 gText_DexHoennDescription[] = _("Tractoria region's Pokédex");
...
const u8 gText_LeagueChamp[] = _("Graduated with honors!\nCongratulations!");
...
const u8 gText_SomeonesPC[] = _("University PC");
...
const u8 gText_TrainerCardMoney[] = _("Wallet");
...
/*const u8 gText_Menu_Gray[] = ("GRAY");
const u8 gText_Menu_Blue[] = ("BLUE");
const u8 gText_Menu_Red[] = ("RED");
const u8 gText_Menu_Green[] = ("GREEN");
const u8 gText_Menu_Pink[] = ("PINK");
const u8 gText_Menu_Yellow[] = ("YELLOW");
const u8 gText_Menu_Purple[] = ("PURPLE");
const u8 gText_Menu_Black[] = ("BLACK");*/
...
const u8 gText_DexHoenn[] = _("Tractoria");
