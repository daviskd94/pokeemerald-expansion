...
static const u8 sHappyMsg27[] = _("{STR_VAR_1} is smelling the scent\nof flowers.");
...
static const u8 sHappyMsg31[] = _("{STR_VAR_1} seems happy about the\ngreat weather.");
...
static const u8 sNeutralMsg04[] = _("{STR_VAR_1} yawned loudly!");
static const u8 sNeutralMsg05[] = _("{STR_VAR_1} is looking around\nrestlessly.");
...
static const u8 sUpsetMsg02[] = _("…{STR_VAR_1} seems a little\ncold.");
...
static const u8 sSurpriseMsg04[] = _("{STR_VAR_1} stumbled and nearly\nfell!");
...
static const u8 sSurpriseMsg09[] = _("{STR_VAR_1} was surprised that you\nsuddenly spoke to it!");
