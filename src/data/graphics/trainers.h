...
const u32 gTrainerFrontPic_Mario[] = INCBIN_U32("graphics/trainers/front_pics/mario.4bpp.lz");
const u16 gTrainerPalette_Mario[] = INCBIN_U16("graphics/trainers/front_pics/mario.gbapal");
...
const u16 gTrainerPalette_Wally[] = INCBIN_U16("graphics/trainers/palettes/cyrus.gbapal");
...
const u8 gTrainerBackPic_Wally[] = INCBIN_U8("graphics/trainers/back_pics/cyrus.4bpp");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_TRACIE, gTrainerFrontPic_Tracie, gTrainerPalette_Tracie),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ROTCART, gTrainerFrontPic_Rotcart, gTrainerPalette_Rotcart),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MARIO, gTrainerFrontPic_Mario, gTrainerPalette_Mario),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_JOGGER, gTrainerFrontPic_Jogger, gTrainerPalette_Jogger),
