...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_TRACIE,
    TRAINER_PIC_FRONT_RANCHER,
    TRAINER_PIC_FRONT_ROTCART,
    TRAINER_PIC_FRONT_MARIO,
    TRAINER_PIC_FRONT_JOGGER,
...
enum TrainerClassID
{
    ...
    // Everything new beyond this point, starting with Ace Trainer
    TRAINER_CLASS_ACE_TRAINER,
    TRAINER_CLASS_GENESIS,
