...
extern const struct Tileset gTileset_GrayCave;
extern const struct Tileset gTileset_DormHallway;
extern const struct Tileset gTileset_SouthCampusCafeteria;
extern const struct Tileset gTileset_TractorUniversity;
extern const struct Tileset gTileset_Classroom;
extern const struct Tileset gTileset_MainHall;
extern const struct Tileset gTileset_New_Cave;
extern const struct Tileset gTileset_LectureHall;
extern const struct Tileset gTileset_NorthCampusGymnasium;
extern const struct Tileset gTileset_Library;
extern const struct Tileset gTileset_Laboratory;
extern const struct Tileset gTileset_FossilLab;
extern const struct Tileset gTileset_SS_Tractoria;
